      ...
      <div class="shadow sm:rounded-md sm:overflow-hidden">
        ...
        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
          ...
          <div class="flex items-start">
            <div class="flex items-center h-5">
              <input
                ...
                class="focus:ring-offset-indigo-500 h-4 2-4 text-indigo-600 border-gray-300 rounded"
              />
            </div>
          ...
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            >
              Your don't have any question created
            </div>
            <div
...
function saveSurvey() {
  store.dispatch("saveSurvey", model.value).then(({ data }) => {
    store.commit("notify", {
      type: "success",
      message: "Survey salva com sucesso",
    });
    router.push({
      name: "SurveyView",
...
function deleteSurvey() {
  if (
    confirm(`Are you sure want to delete this survey? Operation cant be undone`)
  ) {
